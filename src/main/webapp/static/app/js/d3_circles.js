...
function setup_graphics(){
    ...
    config2.displayPercent = false;
	 ...
	 $.get( "http://localhost:8080/roomie/public/api/RentalUnit/total", 
			  function( data ) {
		 		   loadLiquidFillGauge("fillgauge3", data, config2);
			});
    ...
    $.get( "http://localhost:8080/roomie/public/api/User/total", 
			  function( data ) {
				 loadLiquidFillGauge("fillgauge4", data, config3);
			});
